...
\section{要求}
\begin{enumerate}
  \item {编写用Newton迭代和弦截法解非线性方程的通用程序}
  \item {用如上程序求根
  $$
      f(x)=\dfrac{x^3}{3}-x
  $$
  取初值为$0.1,0.2,0.9,9.0$，给出根和迭代步数}
  \item {分析你看到的结果}
\end{enumerate}
...
示例如下： \\
Newton迭代：\\
初值 0.1 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 0.2 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 0.9 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 9.0 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
........ \\
弦截法：\\
初值 0.0,0.1 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 0.1,0.2 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 0.2,0.9 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
初值 8.0,9.0 , 总迭代步数为 XX 步 , 根为 XXXXXXXXXXXXXXXXX \\
........
